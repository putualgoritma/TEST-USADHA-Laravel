...
class OrdersApiController extends Controller
{
    ...
    public function storeAgent(Request $request)
    {
        ...
        if ($points_balance >= $total) {
            ...
            if ($cbmart > 0) {
                ...
                //trsf ubb mart fee
                $order->points()->attach($points_id, ['amount' => $cbmart, 'type' => 'C', 'status' => 'onhold', 'memo' => 'Pemotongan Poin (Agen UBB Mart) dari ' . $memo, 'customers_id' => $customers_id]);
            }
    ...
    public function store(Request $request)
    {
        ...
        if ($points_balance >= $total) {
            ...
            ProcessPairing::dispatch($order->id, $member->ref_id, $bv_total, $bvcv_row[0]->amount, $ref1_fee_point_sale, $ref1_fee_point_upgrade, $ref2_fee_point_sale, $ref2_fee_point_upgrade, $ref1_flush_out, $ledger_id, $cba2, $cbmart, $points_fee_id, 2, $ref2_id, $memo, $member_get_flush_out, $package_type, $ref_fee_lev);
